...
static_assert(GMOCK_PP_CAT(1, 4)
== 14, "");
...
static_assert (GMOCK_PP_NARG()

== 1, "");

static_assert (GMOCK_PP_NARG(x)

== 1, "");

static_assert (GMOCK_PP_NARG(x, y)

== 2, "");

static_assert (GMOCK_PP_NARG(x, y, z)

== 3, "");

static_assert (GMOCK_PP_NARG(x, y, z, w)
...
"");
static_assert(!GMOCK_PP_IS_EMPTY(()), "");
static_assert(GMOCK_PP_IF(1, 1, 2)
== 1, "");
static_assert(GMOCK_PP_IF(0, 1, 2)
== 2, "");

static_assert (GMOCK_PP_NARG0(x)

== 1, "");

static_assert (GMOCK_PP_NARG0(x, y)

== 2, "");
static_assert(GMOCK_PP_HEAD(1)
== 1, "");
static_assert(GMOCK_PP_HEAD(1, 2)
== 1, "");
static_assert(GMOCK_PP_HEAD(1, 2, 3)
== 1, "");
static_assert(GMOCK_PP_TAIL(1, 2)
== 2, "");
static_assert(GMOCK_PP_HEAD(GMOCK_PP_TAIL(1, 2, 3))
== 2, "");
static_assert(!
GMOCK_PP_IS_BEGIN_PARENS(sss),
"");
static_assert(!
...
ss), "");
static_assert(!
GMOCK_PP_IS_ENCLOSED_PARENS(sss),
"");
static_assert(!
...
GMOCK_PP_IS_ENCLOSED_PARENS((sss)
ss), "");
static_assert(GMOCK_PP_REMOVE_PARENS((1 + 1))
* 2 == 3, "");
static_assert(GMOCK_PP_INC(4)
== 5, "");
...
static_assert (GMOCK_PP_INTERNAL_VAR_TEST(x, y)

== 2, "");

static_assert (GMOCK_PP_INTERNAL_VAR_TEST(silly)

== 1, "");

static_assert (GMOCK_PP_INTERNAL_VAR_TEST(x, y, z)
